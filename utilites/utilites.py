...
def add_russian_stress(text):
    """
    Добавляет ударения в русский текст, используя простой словарь ударений.
    Возвращает текст с символом '+' после ударной гласной.
    """
    # Словарь наиболее частых слов с ударениями
    stress_dict = {
        'привет': 'приве+т', 'спасибо': 'спаси+бо', 'пожалуйста': 'пожа+луйста',
        'здравствуйте': 'здра+вствуйте', 'до свидания': 'до свида+ния',
        'хорошо': 'хорошо+', 'плохо': 'пло+хо', 'очень': 'о+чень',
        'можно': 'мо+жно', 'нельзя': 'нельзя+', 'нужно': 'ну+жно',
        'сегодня': 'сего+дня', 'вчера': 'вчера+', 'завтра': 'за+втра',
        'время': 'вре+мя', 'место': 'ме+сто', 'дело': 'де+ло',
        'работа': 'рабо+та', 'дом': 'до+м', 'семья': 'семья+',
        'друг': 'дру+г', 'любовь': 'любо+вь', 'жизнь': 'жи+знь',
        'человек': 'челове+к', 'люди': 'лю+ди', 'ребенок': 'ребё+нок',
        'мама': 'ма+ма', 'папа': 'па+па', 'сын': 'сы+н', 'дочь': 'до+чь',
        'брат': 'бра+т', 'сестра': 'сестра+', 'дедушка': 'де+душка',
        'бабушка': 'ба+бушка', 'учитель': 'учи+тель', 'врач': 'вра+ч',
        'студент': 'студе+нт', 'школа': 'шко+ла', 'университет': 'университе+т',
        'книга': 'кни+га', 'фильм': 'фи+льм', 'музыка': 'му+зыка',
        'еда': 'еда+', 'вода': 'вода+', 'хлеб': 'хле+б', 'молоко': 'молоко+',
        'мясо': 'мя+со', 'рыба': 'ры+ба', 'овощи': 'о+вощи', 'фрукты': 'фру+кты',
        'красивый': 'краси+вый', 'умный': 'у+мный', 'добрый': 'до+брый',
        'большой': 'большо+й', 'маленький': 'ма+ленький', 'новый': 'но+вый',
        'старый': 'ста+рый', 'молодой': 'молодо+й', 'быстро': 'бы+стро',
        'медленно': 'ме+дленно', 'тихо': 'ти+хо', 'громко': 'гро+мко',
        'далеко': 'далеко+', 'близко': 'бли+зко', 'высоко': 'высоко+',
        'низко': 'ни+зко', 'рано': 'ра+но', 'поздно': 'по+здно',
        'всегда': 'всегда+', 'никогда': 'никогда+', 'иногда': 'иногда+',
        'часто': 'ча+сто', 'редко': 'ре+дко', 'много': 'мно+го', 'мало': 'ма+ло'
    }
    ...
    for word in words:
        ...
        elif re.match(r'\w+', word):  # Если это слово без ударения в словаре
            # Простая эвристика: ставим ударение на предпоследний слог для слов > 2 слогов
            vowels = 'аеёиоуыэюя'
